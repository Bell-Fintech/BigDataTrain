...
列：所有列
表：emp
条件：部门编号=10并且job为经理，和部门编号=30并且job为销售员
*/
SELECT * FROM emp WHERE (deptno=10 AND job='经理') OR (deptno=30 AND job='销售员');

/**********************************************/

/*6. 找出部门编号为10中所有经理，部门编号为30中所有销售员，还有即不是经理又不是销售员但其工资大或等于20000的所有员工详细资料。*/
/*
分析：
列：所有列
表：emp
条件：deptno=10 and job='经理', depnto=30 and job='销售员', job not in ('销售员','经理') and sal>=20000
*/
