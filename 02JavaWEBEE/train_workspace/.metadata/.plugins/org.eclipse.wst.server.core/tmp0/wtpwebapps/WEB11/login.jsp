        ...
        <div class="row">
            <div class="col-sm-7">
                <div class="signin-info">
                    ...
                    <ul class="m-b">
                        <li><i class="fa fa-arrow-circle-o-right m-r-xs"></i> 刺激</li>
                        <li><i class="fa fa-arrow-circle-o-right m-r-xs"></i> 新颖</li>
                        <li><i class="fa fa-arrow-circle-o-right m-r-xs"></i> 便宜</li>
                        <li><i class="fa fa-arrow-circle-o-right m-r-xs"></i> 超前</li>
            ...
            <div class="col-sm-5">
                <form method="post" action="/com.edu360/Login">
