...
<body class="bg_color3 wid" onload="initial();">
	<div class="pagebody8">
        ...
        <span>发布者：<a href="${ctx}/salecommodityAction.do?method=getSellerList&userId=${item.userId}">${user.loginName}</a></span>
        <span class="fr">已有<i id="count">${item.collectionsCount}</i>人收藏
