 ...
 function login(){
	 ...
	 if(loginName1==''||password1==''||validateCode1==''){
		 ...
		 $.ajax({
				...
				data:{loginName:loginName1,password:password1,validateCode:validateCode1},
    ...
    <div class="land">
    	<div class="wid land_1">
        	...
        	<form id="loginForm"  action="login.jsp" method="post">
            	<div class="login_name"><input style="width:268px;height:38px;font-size:14px;font-family:'微软雅黑';color:#494848;padding-left:13px;border:1px solid #cdcdcd;" type="text" placeholder="用户名/邮箱/手机号"  id="loginName"/> </div>
                ...
                <input type="text" style="width:100px;height:38px;font-size:14px;font-family:'微软雅黑';color:#494848;padding-left:13px;border:1px solid #cdcdcd;" name="validateCode" id="validateCode" class="delValue"  placeholder="验证码"/>
