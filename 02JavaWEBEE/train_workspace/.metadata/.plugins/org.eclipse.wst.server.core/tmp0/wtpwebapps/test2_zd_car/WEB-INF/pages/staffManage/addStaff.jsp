...
<body style="background: rgba(255,255,255,1);">
    <div class="pagebody13 wid" style="width:890px;">
        ...
        <div class="pagebody13_right" style="width:630px">
            <form action="${ctx}/staffManage/addStaffManage.shtml" method="post"  id="registerForm">
            <ul>
                <h3>新增用户</h3>
                <li><span>关联号码:</span><input class="user" type="text" placeholder="关联号码" name="im"></li>
                <li style="font-size:14px;color:#999;padding-left:5px;">如果您没有IM号码，请先 <a style="color:#c30d23;" href="">注册</a></li>
                ...
                <li><span>QQ号码:</span><input class="user" type="text" placeholder="QQ号码" name="qq" id="qq"></li>
