...
<link rel="stylesheet" type="text/css"
	href="${ctx}/js/jBox/Skins-maitian/maitian-simple/jbox.css" />
...
<SCRIPT type="text/javascript">
        ...
        var zNodes =[
            <c:forEach items="${brandList}" var="menu">{id:"${menu.id}", pId:"${menu.parentId}", name:"${menu.brandName}"},
            </c:forEach>]
...
<script type="text/javascript">
	...
	function productgroupedit(id) {
			$.jBox("iframe:${ctx}/collection/toCollection.shtml?id="+id, {
			title : "商品详情",
			attach: $('#idett'),
			width : 1020,
			height : 700,
...
<body>
	...
	<div class="bg_color1" id="idett">
		...
		<div class="pagebody1" style="height: 700px">
			...
			<div class="wid">
				...
				<div class="pagebody1_right">
					<form id="searchPublicForm" name="searchPublicForm"
						...
						<input name="title" type="text" class="input4" placeholder="标题"
							value="${page.t.title}" /> <input name="content" type="text"
							class="input4" placeholder="描述" value="${page.t.content}" /> <input
							type="text" class="input4" id="parentMenuObj" name="brandName"
							value="${brandName}" readonly="true"
							onclick="showMenu(); return false;" placeholder="汽车品牌" /></span> <input
							type="hidden" id="parentId" name="brandId"
							value="${page.t.brandId}"> <select class="input1"
							id="partId" name="partsId" placeholder="配件类别">
							...
							value="搜&nbsp;&nbsp;索" class="pagebody1_btn" /> <!-- ztree展示的容器 -->
			...
			<!--翻页按钮-->
			<ul class="page">
				<pg:pager url="${ctx}/public/publicList.shtml"
