...
public class Server {
	...
	private static void saveJar(BufferedInputStream bis, BufferedWriter bw, String savePath) {
	 ...
	 * @throws Exception
	 */
	private static String readFourString(BufferedInputStream bis) throws IOException, Exception {
