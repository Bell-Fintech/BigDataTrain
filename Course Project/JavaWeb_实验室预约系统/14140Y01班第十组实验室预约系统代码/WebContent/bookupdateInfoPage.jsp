...
<div id="one">
  ...
  <% 
    ...
    %>
    <form name="form1" method="post" action="bookupdateInfoPageServlet">
    <table width="1000" height="300" border="1" align="center">

 
  <tr><td>用户名：</td><td colspan="3"><input name="username" type="text" ></td></tr>
  ...
  <tr><td>密&nbsp;码：</td><td colspan="3"><input name="password" type="password" ></td></tr>
        ...
        <SELECT name="name" >
         <OPTION value="0">请选择实验室 --</OPTION>
      	...
      	<tr><td>时间段:</td><td><select name="week" onChange="getDay()" >
              <option value="0" >请选择--</option>
     ...
     <tr><td>预约人数:</td><td colspan="3"><input   name="sbook" type="text"></td></tr>
     <tr><td colspan="4"><input name="Submit"type="submit"></td></tr>
       <tr><td colspan="4"><input name="Reset"type="reset"></td></tr>
