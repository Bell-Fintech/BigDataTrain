...
<br>
   ...
   <jsp:useBean id="mDao"  class="nuc.sw.dao.ManagerDao"></jsp:useBean>
	 <center>
 <table border="1" width="800" height="300" border="1" align="center">
   <tr>
   ...
   <tr>
     <td align="center"><a href="book.jsp"id="" style="font-size:12px!important;;font-weight:12px!important;;">预约实验室信息</a></td> 
     <td align="center"><a href="bookShowInfoServlet"id="" style="font-size:12px!important;;font-weight:12px!important;;">查看预约信息</a></td>
     <td align="center"><a href="bookupdateInfoPage.jsp"id="" style="font-size:12px!important;;font-weight:12px!important;;">修改预约信息</a></td>
     <td align="center"><a href="bookdeleteInfoServlet"  onclick="return confirm('你确定要删除吗？')"id="" style="font-size:12px!important;;font-weight:12px!important;;">删除预约信息</a></td>
