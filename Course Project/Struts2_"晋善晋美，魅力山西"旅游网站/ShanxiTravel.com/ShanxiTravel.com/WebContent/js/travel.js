...
$("#head_car").hover(function(){
    ...
    $("#car_content").css({"width":"299px"}).animate({
        height:"100px"});
    $(".car_text").css("display", "");//��ʾ���ﳵ���ﳵ���ı�
    $(".car_text").css("border-bottom", "1px solid grey");
    ...
    $(".car_text").css("display", "none");//���ع��ﳵ���ı�
    $(".car_text").css("border-bottom", "0px");
})
...
$("#menu_content_ul").children().hover(function(){
    $("#menu_content_bg").css("border","1px solid #D0D0D0");
    $("#menu_content_bg").height(230);
},function(){
    $("#menu_nav_ul").children().css("color"," #424242");
    $(this).hide();
    $(this).css("color"," #424242");
...
$(function(){
    ...
    function img_change(){
        var img_i=i*-1226+"px";
        big_banner_pic.animate({opacity:"1"},100,function(){
...
//��ͣ��Ӱ(1)
$(".news_notice_comment_li").hover(function () {
